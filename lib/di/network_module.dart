...
import '../data/remote/services/news_api.dart';
@module
abstract class NetworkModule {
  ...
  Dio getDio(
    ...
    )..interceptors.addAll([ cookieInterceptor]);
  ...
  @singleton
  NewsApi getNewsService(Dio dio) => NewsApi(dio, baseUrl: 'https://67e501bf18194932a58410cf.mockapi.io');
}